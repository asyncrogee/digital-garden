...
## Resources
### Visualizer: 
- [Python Tutor: Visualizer](https://pythontutor.com/visualize.html#mode=edit)
### Roadmap:
...
- [30 Days of Python (Github)](https://github.com/Asabeneh/30-Days-Of-Python/tree/master)
### Practice Problems
- [HackInScience's Python Exercises](https://www.hackinscience.org/exercises/)
- [Practice Python](https://www.practicepython.org/)
- [Exercism's Python Exercises](https://exercism.org/tracks/python/exercises)